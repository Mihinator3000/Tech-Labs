...
import main.banks.entities.accounts.CreditAccount;
...
public record CreditAccountCreator() implements AccountCreator {

    public Account create(Bank bank, Client client, BigDecimal balance) throws BanksException {
        return new CreditAccount(bank, client, balance);
    }
}